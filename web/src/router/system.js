...
import Machine from '@/views/system/Machine.vue'
import K8sPermission from '@/views/K8s/k8s-permission.vue'
...
const routes = [
    ...
    },
    {
        path: '/system/machine',
        component: Machine,
        meta: { sTitle: '基础管理', tTitle: '机房信息' }
    },
    {
        path: '/system/asset-permission',
        component: AssetPermission,
        meta: { sTitle: '基础管理', tTitle: '资产授权' }
    },
    {
        path: '/system/k8s-permission',
        component: K8sPermission,
        meta: {sTitle: '基础管理', tTitle: '容器授权'}
    },
    {
